          ...
          <div>
            ...
            >
              <div className="relative inline-block group">
                ...
                <img src="/images/golfield-logo.png" alt="Golfield" className="relative h-32 md:h-44 lg:h-52 w-auto min-w-[280px] md:min-w-[360px] lg:min-w-[420px] rounded-2xl object-contain shadow-2xl shadow-primary/10 bg-card/40 p-3 md:p-4 backdrop-blur-sm transition-transform duration-500 group-hover:scale-[1.03]" />
              </div>
            </motion.div>
