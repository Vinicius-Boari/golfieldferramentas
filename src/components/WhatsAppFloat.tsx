...
// forwardRef so framer-motion (parent <motion.a>) can attach refs without React warnings.
const WhatsAppIcon = forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement>>((props, ref) => (
  <svg ref={ref} width={26} height={26} viewBox="0 0 24 24" fill="currentColor" {...props}>
